...
<head>
    <title>Government View Public Complaints</title>
    ...
    <div class="container">
        <div class="jumbotron" style="background: #24252a;">
            ...
            <td><a class="btn btn-primary"
                    href="viewGovernmentComplaintView.php?user_complaint_id=<?php echo $row["user_complaint_id"]; ?>">View</a>
            </td>
            <?php echo"</tr>";
                    }
                    echo "</table>";
                    ...
                    echo "<h1>No Complaints Posted...!!!</h1>";
            ?>
        </div>
    </div>
</body>
